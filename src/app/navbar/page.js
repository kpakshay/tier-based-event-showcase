                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:ml-6 sm:block">
                            <div class="flex space-x-4">
                                ...
                                <a href="/home"  class={`rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white ${pathname=="/home"?"bg-gray-700 text-white":''}`}>Dashboard</a>
                                <a href="/events" class={`rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white ${pathname=="/events"?"bg-gray-700 text-white":''}`}>Events</a>
                                {/* <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Projects</a> */}
                                <a href="/aboutus" class={`rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white ${pathname=="/aboutus"?"bg-gray-700 text-white":''}`}>About Us</a>
                            </div>
                        </div>
                    </div>
